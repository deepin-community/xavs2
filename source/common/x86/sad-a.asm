...
%macro PROCESS_SAD_24x4 0
    ...
    movu        m3,  [r2]
    movq        m4,  [r2 + 16]
%ifdef USING_OLD_SAD_24x32            ; --- fixed by sfdong
    psadbw      m1,  [r0]             ; !!!r0 align 16-byte?
    psadbw      m3,  [r0 + r1]        ; !!!r0 align 16-byte?
%else
    movu        m5,  [r0]
    movu        m6,  [r0 + r1]
    psadbw      m1,  m5
...
%macro SAD_X3_12x4 0
    movu    m3,  [r0]                       ; mova  - fixed by sfdong
    movu    m5,  [r1]
    pand    m3,  m4
    pand    m5,  m4
    psadbw  m5,  m3
    ...
    psadbw  m5,  m3
    paddd   m2,  m5
    movu    m3,  [r0 + FENC_STRIDE]         ; mova  - fixed by sfdong
    movu    m5,  [r1 + r4]
    pand    m3,  m4
    pand    m5,  m4
    psadbw  m5,  m3
    ...
    psadbw  m5,  m3
    paddd   m2,  m5
    movu    m3,  [r0 + FENC_STRIDE * 2]     ; mova  - fixed by sfdong
    movu    m5,  [r1 + r4 * 2]
    pand    m3,  m4
    pand    m5,  m4
    psadbw  m5,  m3
    ...
    lea     r2, [r2 + r4 * 2]
    lea     r3, [r3 + r4 * 2]
    movu    m3,  [r0 + FENC_STRIDE * 3]     ; mova  - fixed by sfdong
    movu    m5,  [r1 + r4]
    pand    m3,  m4
    pand    m5,  m4
    psadbw  m5,  m3
...
%macro SAD_X4_12x4 0
    movu    m4,  [r0]                       ; mova  - fixed by sfdong
    movu    m5,  [r1]
    pand    m4,  m6
    pand    m5,  m6
    psadbw  m5,  m4
    ...
    psadbw  m5,  m4
    paddd   m3,  m5
    movu    m4,  [r0 + FENC_STRIDE]         ; mova  - fixed by sfdong
    movu    m5,  [r1 + r5]
    pand    m4,  m6
    pand    m5,  m6
    psadbw  m5,  m4
    ...
    psadbw  m5,  m4
    paddd   m3,  m5
    movu    m4,  [r0 + FENC_STRIDE * 2]     ; mova  - fixed by sfdong
    movu    m5,  [r1 + r5 * 2]
    pand    m4,  m6
    pand    m5,  m6
    psadbw  m5,  m4
    ...
    lea     r3, [r3 + r5 * 2]
    lea     r4, [r4 + r5 * 2]
    movu    m4,  [r0 + FENC_STRIDE * 3]     ; mova  - fixed by sfdong
    movu    m5,  [r1 + r5]
    pand    m4,  m6
    pand    m5,  m6
    psadbw  m5,  m4
...
%macro SAD_X3_24x4 0
    movu    m3,  [r0     ]                  ; mova  - fixed by sfdong
    movu    m4,  [r0 + 16]                  ; mova  - fixed by sfdong
    movu    m5,  [r1]
    movu    m6,  [r1 + 16]
    psadbw  m5,  m3
    psadbw  m6,  m4
    ...
    movu    m3,  [r0 + FENC_STRIDE]         ; mova  - fixed by sfdong
    movu    m4,  [r0 + 16 + FENC_STRIDE]    ; mova  - fixed by sfdong
    movu    m5,  [r1 + r4]
    movu    m6,  [r1 + 16 + r4]
    psadbw  m5,  m3
    psadbw  m6,  m4
    ...
    movu    m3,  [r0 + FENC_STRIDE * 2]         ; mova  - fixed by sfdong
    movu    m4,  [r0 + 16 + FENC_STRIDE * 2]    ; mova  - fixed by sfdong
    movu    m5,  [r1 + r4 * 2]
    movu    m6,  [r1 + 16 + r4 * 2]
    psadbw  m5,  m3
    psadbw  m6,  m4
...
%macro SAD_X4_24x4 0
    movu    m4,  [r0     ]                  ; mova  - fixed by sfdong
    movu    m5,  [r0 + 16]                  ; mova  - fixed by sfdong
    movu    m6,  [r1]
    movu    m7,  [r1 + 16]
    psadbw  m6,  m4
    psadbw  m7,  m5
    ...
    movu    m4,  [r0 + FENC_STRIDE]         ; mova  - fixed by sfdong
    movu    m5,  [r0 + 16 + FENC_STRIDE]    ; mova  - fixed by sfdong
    movu    m6,  [r1 + r5]
    movu    m7,  [r1 + 16 + r5]
    psadbw  m6,  m4
    psadbw  m7,  m5
    ...
    movu    m4,  [r0 + FENC_STRIDE * 2]         ; mova  - fixed by sfdong
    movu    m5,  [r0 + 16 + FENC_STRIDE * 2]    ; mova  - fixed by sfdong
    movu    m6,  [r1 + r5 * 2]
    movu    m7,  [r1 + 16 + r5 * 2]
    psadbw  m6,  m4
    psadbw  m7,  m5
